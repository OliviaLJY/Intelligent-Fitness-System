    ...
    <div class="apple-auth-content">
      <div class="apple-auth-card">
        ...
        <div class="apple-auth-header">
          ...
          <h1 class="apple-auth-title">Welcome Back</h1>
          <p class="apple-auth-subtitle">Sign in to continue your fitness journey</p>
        </div>

        <!-- Form -->
        <form class="apple-auth-form" @submit.prevent="handleLogin">
          <!-- Email Field -->
          ...
          <div class="apple-form-options">
            <label class="apple-checkbox-container">
              ...
              <span class="apple-checkbox-label">Remember me</span>
            </label>
            <button type="button" class="apple-link-button">
              Forgot password?
            </button>
          </div>
        ...
        <div class="apple-auth-footer">
          <p class="apple-footer-text">
            ...
            <router-link to="/auth/register" class="apple-footer-link">
              Sign up
            </router-link>
          </p>
        </div>
...
.apple-checkbox-mark {
  @apply w-5 h-5 bg-gray-200 rounded border border-gray-300 flex items-center justify-center mr-3 transition-all duration-200;
}
...
.apple-link-button {
  @apply text-sm text-blue-500 hover:text-blue-600 font-medium transition-colors duration-200;
}
